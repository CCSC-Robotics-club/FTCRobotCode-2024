...
public class ArmService extends RobotService {
    ...
    public void periodic(double dt) {
        if (Math.abs(copilotGamepad.left_stick_y) > 0.05) {
            ...
            this.currentArmCommand = new Arm.ArmCommand(Arm.ArmCommand.ArmCommandType.SET_POSITION, 0);
        ...
        else if (copilotGamepad.left_trigger > RobotConfig.ControlConfigs.triggerThreshold) arm.closeClaw(this);
