...
public class FlyWheelSpeedController implements MechanismController {
    private SimpleFeedBackSpeedController simpleFeedBackSpeedController;
    ...
    public FlyWheelSpeedController(FlyWheelSpeedControllerProfile profile) {
        ...
        this.simpleFeedBackSpeedController = new SimpleFeedBackSpeedController(profile);
        this.desiredSpeed = 0;
    ...
    public double getCorrectionPower(double currentSpeed) {
        ...
        final double correctionSpeed = simpleFeedBackSpeedController.getSpeedControlPower(
    ...
    public static class FlyWheelSpeedControllerProfile extends SimpleFeedBackSpeedController.SimpleFeedBackControllerProfile {
